...
class ImageDataset(Dataset):
    ...
    def split_dataset(self, train_ratio=0.8, val_ratio=0.1, test_ratio=0.1, random_seed=42):
        ...
        train_idx, temp_idx = train_test_split(
            indices, train_size=train_ratio, random_state=random_seed, stratify=labels
        )
        ...
        val_idx, test_idx = train_test_split(
            temp_idx, train_size=val_test_ratio, random_state=random_seed, stratify=temp_labels
        )
